export default function SLIDhassan(){
    return(
        <section className="overflow-hidden rounded-lg shadow-2xl  md:grid md:grid-cols-3 px-10 mt-10 mx-36">
  {/* <img
    alt=""
...
<img src={require('./image/IMAGE.jpg')} className="h-32 mt-8 mb-8 w-full object-cover md:h-full"/>

  <div className="p-4 text-center sm:p-6 md:col-span-2 lg:p-8 align-middle">
